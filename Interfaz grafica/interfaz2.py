...
miFrame.pack(fill = "x") # lo que hace la "x" es que el frame siga a lo largo a la raiz pero no en lo alto, la "y" hace lo contrario, el expand debería seguirlo en ambos
